...
public class MoreVarientsModBlocks {
	...
	public static final RegistryObject<Block> ACACIA_PILLARS = REGISTRY.register("acacia_pillars", () -> new AcaciaPillarsBlock());
	public static final RegistryObject<Block> BAMBOO_PILLARS = REGISTRY.register("bamboo_pillars", () -> new BambooPillarsBlock());
	public static final RegistryObject<Block> BIRCH_PILLARS = REGISTRY.register("birch_pillars", () -> new BirchPillarsBlock());
	public static final RegistryObject<Block> CHERRY_PILLAR = REGISTRY.register("cherry_pillar", () -> new CherryPillarBlock());
	public static final RegistryObject<Block> CRIMSON_PILLARS = REGISTRY.register("crimson_pillars", () -> new CrimsonPillarsBlock());
	public static final RegistryObject<Block> DARK_OAK_PILLARS = REGISTRY.register("dark_oak_pillars", () -> new DarkOakPillarsBlock());
	public static final RegistryObject<Block> JUNGLE_PILLARS = REGISTRY.register("jungle_pillars", () -> new JunglePillarsBlock());
	public static final RegistryObject<Block> MANGROVE_PILLARS = REGISTRY.register("mangrove_pillars", () -> new MangrovePillarsBlock());
	public static final RegistryObject<Block> OAK_PILLARS = REGISTRY.register("oak_pillars", () -> new OakPillarsBlock());
	public static final RegistryObject<Block> SPRUCE_PILLARS = REGISTRY.register("spruce_pillars", () -> new SprucePillarsBlock());
	public static final RegistryObject<Block> WARPED_PILLARS = REGISTRY.register("warped_pillars", () -> new WarpedPillarsBlock());
	public static final RegistryObject<Block> FROST_WHITE_WOOL = REGISTRY.register("frost_white_wool", () -> new FrostWhiteWoolBlock());
	public static final RegistryObject<Block> FROST_LIGHT_GRAY_WOOL = REGISTRY.register("frost_light_gray_wool", () -> new FrostLightGrayWoolBlock());
	public static final RegistryObject<Block> FROST_GRAY_WOOL = REGISTRY.register("frost_gray_wool", () -> new FrostGrayWoolBlock());
	public static final RegistryObject<Block> FROST_BLACK_WOOL = REGISTRY.register("frost_black_wool", () -> new FrostBlackWoolBlock());
	public static final RegistryObject<Block> FROST_BROWN_WOOL = REGISTRY.register("frost_brown_wool", () -> new FrostBrownWoolBlock());
	public static final RegistryObject<Block> FROST_RED_WOOL = REGISTRY.register("frost_red_wool", () -> new FrostRedWoolBlock());
	public static final RegistryObject<Block> FROST_ORANGE_WOOL = REGISTRY.register("frost_orange_wool", () -> new FrostOrangeWoolBlock());
	public static final RegistryObject<Block> FROST_YELLOW_WOOL = REGISTRY.register("frost_yellow_wool", () -> new FrostYellowWoolBlock());
	public static final RegistryObject<Block> FROST_LIME_WOOL = REGISTRY.register("frost_lime_wool", () -> new FrostLimeWoolBlock());
	public static final RegistryObject<Block> FROST_GREEN_WOOL = REGISTRY.register("frost_green_wool", () -> new FrostGreenWoolBlock());
	public static final RegistryObject<Block> FROST_CYAN_WOOL = REGISTRY.register("frost_cyan_wool", () -> new FrostCyanWoolBlock());
	public static final RegistryObject<Block> FROST_LIGHT_BLUE_WOOL = REGISTRY.register("frost_light_blue_wool", () -> new FrostLightBlueWoolBlock());
	public static final RegistryObject<Block> FROST_BLUE_WOOL = REGISTRY.register("frost_blue_wool", () -> new FrostBlueWoolBlock());
	public static final RegistryObject<Block> FROST_PURPLE_WOOL = REGISTRY.register("frost_purple_wool", () -> new FrostPurpleWoolBlock());
	public static final RegistryObject<Block> FROST_MAGENTA_WOOL = REGISTRY.register("frost_magenta_wool", () -> new FrostMagentaWoolBlock());
	public static final RegistryObject<Block> FROST_PINK_WOOL = REGISTRY.register("frost_pink_wool", () -> new FrostPinkWoolBlock());
